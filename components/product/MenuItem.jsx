...
const MenuItem = ({ product }) => {
  ...
  return (
    <div className="bg-secondary rounded-3xl">
      <div className="w-full  bg-[#222831] h-[210px] grid place-content-center rounded-bl-[46px] rounded-tl-2xl rounded-tr-2xl">
        <Link href={`/product/${product._id}`}>
          <div className="relative w-48 h-44 hover:scale-125 transition-all">
