      ...
      <div className="container mx-auto text-white flex justify-between items-center h-full">
        ...
        >
          <ul className="flex gap-x-2 sm:flex-row flex-col items-center">
            <li
              className={`px-[5px] py-[10px] uppercase hover:text-black font-bold cursor-pointer ${
                router.asPath === "/" && "text-black"
              }`}
              onClick={() => setIsMenuModal(false)}
            >
              <Link href="/">
                <a className="px-1 py-2">Anasayfa</a>
              </Link>
            </li>
            <li
              className={`px-[5px] py-[10px] uppercase hover:text-black font-bold cursor-pointer ${
            ...
            >
              <Link href="/about">
                <a className="px-1 py-2">Hakkımızda</a>
              </Link>
            </li>
            <li
              className={`px-[5px] py-[10px] uppercase hover:text-black font-bold cursor-pointer ${
            ...
            >
              <Link href="/reservation">
                <a className="px-1 py-2">Rezervasyon</a>
              </Link>
            </li>
          </ul>
          {isMenuModal && (
